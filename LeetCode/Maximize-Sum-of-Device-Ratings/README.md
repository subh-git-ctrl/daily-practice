...
Can you solve this real interview question? Maximize Sum of Device Ratings - You are given a 2D integer array units of size m × n where units[i][j] represents the capacity of the jth unit in the ith device. Each device contains exactly n units.
